<?php /*a:2:{s:68:"E:\PHP\www\spladmin\application\admin\view\privilege_role\index.html";i:1545097186;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            ...
            <form id="searchForm" class="form-inline row" action="" method="get">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="role_name" data-where="like" class="form-control" placeholder="角色名称">
                    </div>
                </div>
...
<script src="/public/admin/js/iframe.js"></script>
    ...
    <script type="text/javascript">
        ...
        var fieldList = [
            ...
            {
            valign:"middle",field:"role_name",title:"角色名称"
            },
        ];
        var columns = [{
            align: 'center',
        ...
        function changeState(id,field,value) {
            $.ajax({
                url:'<?php echo url("PrivilegeRole/changeState"); ?>',
                type:'post',
                dataType:'json',
        ...
        function add () {
            ...
            layer.open({
                ...
                shade:0,//隐藏遮罩层
                area : area,
                content: '<?php echo url("PrivilegeRole/add"); ?>',
                btn:['确定','重置'],
                btnAlign:'c',
        ...
        function handleEdit(id){
            ...
            layer.open({
                ...
                shade:0,//隐藏遮罩层
                area : area,
                content: '<?php echo url("PrivilegeRole/edit"); ?>?id=' + id,
                btn:['保存','取消'],
                btnAlign:'c',
                yes:function (index,layero) {
                    var iframe = layero.find("iframe")[0].contentWindow.document;
        ...
        function handleDelete(ids) {
            $.ajax({
                url:'<?php echo url("PrivilegeRole/delete"); ?>',
                type:'post',
                dataType:'json',
                data:{ids:ids},
                success:function (response) {
        ...
        function oTableInit() {
            $('#table').bootstrapTable({
                url:'<?php echo url("PrivilegeRole/index"); ?>',
