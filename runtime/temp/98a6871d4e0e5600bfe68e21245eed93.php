<?php /*a:2:{s:60:"E:\PHP\www\spladmin\application\admin\view\article\edit.html";i:1545461495;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            <form class="form-horizontal editForm" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['article']); ?>" name="article" class="form-control" required data-msg="文章标题不能为空">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" name="article_image"  value="<?php echo htmlentities($data['article_image']); ?>" readonly  unselectable="on" required data-msg="请上传缩略图">
                    </div>
                    <div class="col-xs-2">
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-xs-8 spl_callback">
                                <?php if($data['article_image'] != ''): if('image' == 'file'): ?>
                                        <div class="col-xs-8">
                                            <button type="button" class="btn btn-danger spl-delete-file" data-src="<?php echo htmlentities($data['article_image']); ?>">删除</button>
                                        </div>
                                    <?php elseif('image' === 'image'): ?>
                                        <div class="col-xs-3">
                                            <img src="<?php echo htmlentities($data['article_image']); ?>">
                                            <button type="button" class="btn btn-danger spl-delete-file" data-src="<?php echo htmlentities($data['article_image']); ?>">删除</button>
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <textarea name="seo_content" class="form-control spl_textarea" required data-msg="SEO描述不能为空" cols="30" rows="5"><?php echo htmlentities($data['seo_content']); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <textarea id="article_editor"  name="article_editor" required data-msg="文章详情不能为空" cols="30" rows="5"><?php echo htmlentities($data['article_editor']); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <input type="checkbox" value="<?php echo htmlentities($data['show_status']); ?>" name="show_status" class="switch" checked>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <input  class="form-control dateTimePicker"  type="text" name="publish_time"  value="<?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($data['publish_time'])? strtotime($data['publish_time']) : $data['publish_time'])); ?>" required data-msg="请设置发布时间">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['cat_id']); ?>" name="cat_id" class="form-control" required data-msg="文章分类id不能为空">
                    </div>
                </div>
