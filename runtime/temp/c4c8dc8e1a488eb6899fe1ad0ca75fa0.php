<?php /*a:2:{s:64:"E:\PHP\www\spladmin\application\admin\view\admin_user\index.html";i:1545204707;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            ...
            <form id="searchForm" class="form-inline row" action="" method="get">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="username" data-where="like" class="form-control" placeholder="用户名">
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <label class="control-label col-xs-4">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="nickname" data-where="like" class="form-control" placeholder="昵称">
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <label class="control-label col-xs-4">
                    ...
                    <div class="col-xs-8">
                        <input class="form-control dateRange" type="text" name="login_time" data-where="between" placeholder="上次登录时间">
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    <label class="control-label col-xs-4">
                    ...
                    <div class="col-xs-8">
                        <select class="form-control" name="status" data-where="eq">
...
<script src="/public/admin/js/iframe.js"></script>
    ...
    <script type="text/javascript">
        ...
        var fieldList = [
            ...
            {
            valign:"middle",field:"username",title:"用户名"
            },
            {
            valign:"middle",field:"nickname",title:"昵称"
            },
            {
            valign:"middle",field:"head_image",title:"头像",formatter:function (value,row,index){return imageFormatter('head_image',value,row,index);}
            },
            {
            valign:"middle",field:"role_names",title:"所属角色"
            },
            {
            valign:"middle",field:"login_time",title:"最后一次登录时间",formatter:function (value,row,index){return timeFormatter('login_time',value,row,index);}
            },
            {
            valign:"middle",field:"status",title:"启用",formatter:function (value,row,index){return statusFormatter('status',value,row,index);}
            },
            {
        ...
        function changeState(id,field,value) {
            $.ajax({
                url:'<?php echo url("AdminUser/changeState"); ?>',
                type:'post',
                dataType:'json',
        ...
        function add () {
            ...
            layer.open({
                ...
                shade:0,//隐藏遮罩层
                area : area,
                content: '<?php echo url("AdminUser/add"); ?>',
                btn:['确定','重置'],
                btnAlign:'c',
        ...
        function handleEdit(id){
            ...
            layer.open({
                ...
                shade:0,//隐藏遮罩层
                area : area,
                content: '<?php echo url("AdminUser/edit"); ?>?id=' + id,
                btn:['保存','取消'],
                btnAlign:'c',
                yes:function (index,layero) {
                    var iframe = layero.find("iframe")[0].contentWindow.document;
        ...
        function oTableInit() {
            $('#table').bootstrapTable({
                url:'<?php echo url("AdminUser/index"); ?>',
