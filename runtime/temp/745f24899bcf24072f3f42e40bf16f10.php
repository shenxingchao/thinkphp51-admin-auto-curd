<?php /*a:2:{s:63:"E:\PHP\www\spladmin\application\admin\view\article_cat\add.html";i:1545461206;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            <form class="form-horizontal addForm" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-8">
                        <input type="text" name="cat_name" class="form-control" required data-msg="分类名称不能为空">
                    </div>
                </div>
