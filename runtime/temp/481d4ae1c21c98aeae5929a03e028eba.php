<?php /*a:2:{s:67:"E:\PHP\www\spladmin\application\admin\view\privilege_menu\edit.html";i:1545023973;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            <form class="form-horizontal editForm" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['title']); ?>" name="title" class="form-control" required data-msg="菜单名称不能为空">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['icon']); ?>" name="icon" class="form-control" required data-msg="图标不能为空">
                    </div>
                    <div class="col-xs-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['href']); ?>" name="href" class="form-control" required data-msg="链接不能为空">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['sort']); ?>" name="sort" class="form-control" required data-msg="排序不能为空">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <select class="form-control" name="parent_id"  required data-msg="请选择上级菜单">
                            ...
                            <option value="0" <?php if($data['parent_id'] == 0): ?>selected="selected"<?php endif; ?>>顶级菜单</option>
                            ...
                            <option value="<?php echo htmlentities($cat['id']); ?>" <?php if($data['parent_id'] == $cat['id']): ?>selected="selected"<?php endif; ?>><?php echo htmlentities($cat['title']); ?></option>
