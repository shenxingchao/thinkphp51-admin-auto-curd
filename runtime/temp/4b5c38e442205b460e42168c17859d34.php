<?php /*a:2:{s:63:"E:\PHP\www\spladmin\application\admin\view\admin_user\edit.html";i:1545103739;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            <form class="form-horizontal editForm" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['username']); ?>" name="username" class="form-control" required data-msg="用户名不能为空">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-8">
                        <input type="text" value="<?php echo htmlentities($data['nickname']); ?>" name="nickname" class="form-control" required data-msg="昵称不能为空">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" name="head_image"  value="<?php echo htmlentities($data['head_image']); ?>" readonly  unselectable="on">
                    </div>
                    <div class="col-xs-2">
                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-xs-8 spl_callback">
                                <?php if($data['head_image'] != ''): if('image' == 'file'): ?>
                                        <div class="col-xs-8">
                                            <button type="button" class="btn btn-danger spl-delete-file" data-src="<?php echo htmlentities($data['head_image']); ?>">删除</button>
                                        </div>
                                    <?php elseif('image' === 'image'): ?>
                                        <div class="col-xs-3">
                                            <img src="<?php echo htmlentities($data['head_image']); ?>">
                                            <button type="button" class="btn btn-danger spl-delete-file" data-src="<?php echo htmlentities($data['head_image']); ?>">删除</button>
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8" style="padding-top: 7px;">
                        ...
                        <label style="text-align: right;margin-left: 8px;">
                            <input type="checkbox" value="<?php echo htmlentities($role['id']); ?>" name="role_ids[]" <?php if(in_array($role['id'],$data['role_ids']))echo 'checked="true"'; ?>>
                            <?php echo htmlentities($role['role_name']); ?>
                        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="checkbox" value="<?php echo htmlentities($data['status']); ?>" name="status" class="switch" checked>
                    </div>
                </div>
        ...
        function fileInit() {
            ...
            $('.fileUpload').fileupload({
                ...
                add: function (e, data) {
                    ...
                    $(this).fileupload('option', 'url', "<?php echo url('AdminUser/fileUpload'); ?>?data_type="+data_type);
                    data.submit();
                },
            ...
            $('body').on('click','.spl-delete-file',function () {
                ...
                var obj = $(this);
                $.ajax({
                    url:"<?php echo url('AdminUser/fileDelete'); ?>",
                    type:'post',
                    dataType:'json',
