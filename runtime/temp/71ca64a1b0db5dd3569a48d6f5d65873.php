<?php /*a:2:{s:67:"E:\PHP\www\spladmin\application\admin\view\privilege_src\index.html";i:1545039321;s:54:"E:\PHP\www\spladmin\application\admin\view\iframe.html";i:1545366211;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid content-wrapper-box">
        <div class="content-wrapper">
            ...
            <div id="toolbar">
                ...
                <button class="btn btn-danger btn-sm" id="show_btn" onclick="showDataRow(this)"><i class="fa fa-eye"></i> 隐藏</button>
            </div>
            <!-- 表格 -->
...
<script src="/public/admin/js/iframe.js"></script>
    ...
    <script type="text/javascript">
        ...
        var fieldList = [
            ...
            {
            valign:"middle",field:"title",title:"资源名称"
            },
            {
            valign:"middle",field:"code",title:"权限码"
            }
        ];
        var columns = [{
            align: 'center',
        ...
        function changeState(id,field,value) {
            $.ajax({
                url:'<?php echo url("PrivilegeSrc/changeState"); ?>',
                type:'post',
                dataType:'json',
        ...
        function add () {
            ...
            layer.open({
                ...
                shade:0,//隐藏遮罩层
                area : area,
                content: '<?php echo url("PrivilegeSrc/add"); ?>',
                btn:['确定','重置'],
                btnAlign:'c',
         ...
         * 显示所有数据行
         */
        function showDataRow(obj) {
            if($('.data_row').hasClass('hidden')){
                $(obj).text("隐藏");
                $('.data_row').removeClass('hidden');
            }else{
                $(obj).text("显示");
                $('.data_row').addClass('hidden');
            }
        }
        ...
        function handleEdit(id){
            ...
            layer.open({
                ...
                shade:0,//隐藏遮罩层
                area : area,
                content: '<?php echo url("PrivilegeSrc/edit"); ?>?id=' + id,
                btn:['保存','取消'],
                btnAlign:'c',
                yes:function (index,layero) {
                    var iframe = layero.find("iframe")[0].contentWindow.document;
        ...
        function handleDelete(ids) {
            $.ajax({
                url:'<?php echo url("PrivilegeSrc/delete"); ?>',
                type:'post',
                dataType:'json',
                data:{ids:ids},
                success:function (response) {
        ...
        function oTableInit() {
            $('#table').bootstrapTable({
                url:'<?php echo url("PrivilegeSrc/index"); ?>',
